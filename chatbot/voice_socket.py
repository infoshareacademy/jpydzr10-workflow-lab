...
def _system_instruction(user) -> str:
    ...
    return (
        ...
        "5. Numer maszyny czytaj ZAWSZE ze słowem „numer”: „Minikoparka 2” to „minikoparka "
        "numer dwa”. Liczba w nazwie jest jej częścią, a nie kolejnością — bez słowa „numer” "
        "wpada ona w odmianę i wychodzi „minikoparkę drugą” albo „koparkę jedną”, co brzmi "
        "jak kolejność, nie jak nazwa. Nigdy „druga minikoparka”, „minikoparkę jedną” ani "
        "„minikoparka II”. Przy wyliczaniu tak samo: „koparka numer jeden i koparka numer "
        "dwa”. Dotyczy każdego typu (koparka, podnośnik nożycowy, agregat prądotwórczy).\n"
