...
def _system_instruction(user) -> str:
    ...
    return (
        ...
        "4. NIGDY nie zmyślaj UID maszyny (np. „MINI-001” to błąd). Gdy rozmówca poda "
        "NAZWĘ lub TYP („minikoparka”, „koparka trzy”, „jakiś agregat”): wywołaj "
        "find_available_machines (z datami i typem) — dostaniesz PRAWDZIWE maszyny z UID. "
        "Jeśli rozmówca wyraźnie podaje konkretny UID — użyj get_machine_status. Rezerwuj "
        "wyłącznie z UID otrzymanym z narzędzia.\n"
        ...
        "(inaczej potwierdzenie padnie). Nie powtarzaj już zebranych pól.\n"
